...
var Typography = React6.forwardRef(function Typography2(inProps, ref) {
...
var ListItemText = React7.forwardRef(function ListItemText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemText"
  });
  ...
  const {
    dense
  } = React7.useContext(ListContext_default);
  ...
  if (primary != null && primary.type !== Typography_default && !disableTypography) {
    primary = (0, import_jsx_runtime8.jsx)(Typography_default, _extends({
  ...
  if (secondary != null && secondary.type !== Typography_default && !disableTypography) {
    secondary = (0, import_jsx_runtime8.jsx)(Typography_default, _extends({
      variant: "body2",
  ...
  return (0, import_jsx_runtime9.jsxs)(ListItemTextRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
  }, other, {
...
true ? ListItemText.propTypes = {
   ...
   */
  primary: import_prop_types7.default.node,
  /**
   * These props will be forwarded to the primary typography component
   * (as long as disableTypography is not `true`).
   */
  primaryTypographyProps: import_prop_types7.default.object,
  /**
   * The secondary content element.
   */
  secondary: import_prop_types7.default.node,
  /**
   * These props will be forwarded to the secondary typography component
   * (as long as disableTypography is not `true`).
   */
  secondaryTypographyProps: import_prop_types7.default.object,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var MenuItem = React8.forwardRef(function MenuItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMenuItem"
  });
  ...
  return (0, import_jsx_runtime10.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime10.jsx)(MenuItemRoot, _extends({
      ref: handleRef,
      role,
      tabIndex,
      component,
...
//# sourceMappingURL=chunk-HWCC3EQ4.js.map
