...
function useCurrentColorScheme(options) {
  ...
  const handleMediaQuery = React12.useCallback((e) => {
...
function createGrid(options = {}) {
  ...
  const NestedContext = React15.createContext(0);
  const OverflowContext = React15.createContext(void 0);
  ...
  const Grid2 = React15.forwardRef(function Grid3(inProps, ref) {
    ...
    const level = React15.useContext(NestedContext);
    const overflow2 = React15.useContext(OverflowContext);
    const {
      className,
    ...
    if (container) {
      result = (0, import_jsx_runtime11.jsx)(NestedContext.Provider, {
        value: level + 1,
        children: result
      });
    }
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime13.jsx)(React17.Fragment, {
    children: React17.cloneElement(children, childrenProps)
  });
}
...
true ? FocusTrap.propTypes = {
   ...
   */
  getTabbable: import_prop_types17.default.func,
  /**
   ...
   * }
   */
  isEnabled: import_prop_types17.default.func,
  /**
...
var _excluded16 = ["elementType", "externalSlotProps", "ownerState"];
...
var _excluded17 = ["children", "closeAfterTransition", "component", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "manager", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
var ModalUnstyled = React21.forwardRef(function ModalUnstyled2(props, forwardedRef) {
...
var _excluded18 = ["onChange", "maxRows", "minRows", "style", "value"];
...
var TextareaAutosize = React23.forwardRef(function TextareaAutosize2(props, ref) {
  const {
    onChange,
    maxRows,
    minRows = 1,
...
var _excluded19 = ["anchorEl", "children", "component", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"];
...
function useSnackbar(parameters) {
  ...
  const timerAutoHide = React27.useRef();
  React27.useEffect(() => {
    if (!open) {
      return void 0;
    }
...
var _excluded20 = ["badgeContent", "component", "children", "invisible", "max", "slotProps", "slots", "showZero"];
...
var BadgeUnstyled = React28.forwardRef(function BadgeUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime25.jsxs)(Root, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime24.jsx)(Badge, _extends({}, badgeProps, {
...
function useButton(parameters) {
  ...
  const updateHostElementName = React29.useCallback((instance) => {
...
var _excluded21 = ["action", "children", "component", "disabled", "focusableWhenDisabled", "onBlur", "onClick", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseLeave", "slotProps", "slots"];
...
var FormControlUnstyledContext = React31.createContext(void 0);
if (true) {
...
var _excluded24 = ["defaultValue", "children", "component", "disabled", "error", "onChange", "required", "slotProps", "slots", "value"];
...
var FormControlUnstyled = React32.forwardRef(function FormControlUnstyled2(props, ref) {
  var _ref;
  const {
    defaultValue,
    children,
  ...
  const [focusedState, setFocused] = React32.useState(false);
  const focused = focusedState && !disabled;
  React32.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  const ownerState = _extends({}, props, {
    disabled,
    error,
    filled,
  ...
  const childContext = React32.useMemo(() => {
    return {
      disabled,
      error,
      filled,
  ...
  return (0, import_jsx_runtime27.jsx)(FormControlUnstyledContext_default.Provider, {
    value: childContext,
...
function useFormControlUnstyledContext() {
  return React33.useContext(FormControlUnstyledContext_default);
}
...
var InputUnstyled = React35.forwardRef(function InputUnstyled2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime28.jsx)(Input, _extends({}, inputProps)), endAdornment]
  }));
});
...
var MenuUnstyledContext = React36.createContext(null);
...
(function(ActionTypes2) {
  ...
  ActionTypes2["textNavigation"] = "textNavigation";
...
function useControllableReducer(internalReducer, externalReducer, props) {
  ...
  const [nextState, dispatch] = React37.useReducer(combinedReducer, initialState);
  const dispatchWithProps = React37.useCallback((action) => {
    dispatch(_extends({
      props: props.current
    }, action));
  }, [dispatch, props]);
  const previousState = React37.useRef(initialState);
  React37.useEffect(() => {
...
function useTextNavigation(callback) {
  ...
  return React39.useCallback((event) => {
...
function useListbox(props) {
  ...
  const id = useId(idProp);
  const defaultIdGenerator = React40.useCallback((_, index) => `${id}-option-${index}`, [id]);
  ...
  const highlightedIndex = React40.useMemo(() => {
  ...
  const previousOptions = React40.useRef([]);
  React40.useEffect(() => {
  ...
  const setSelectedValue = React40.useCallback((values2) => {
    dispatch({
      type: ActionTypes.setValue,
      event: null,
      value: values2
  ...
  const setHighlightedValue = React40.useCallback((option) => {
    dispatch({
  ...
  const createHandleOptionClick = React40.useCallback((option, other) => (event) => {
    var _other$onClick;
  ...
  const createHandleOptionPointerOver = React40.useCallback((option, other) => (event) => {
  ...
  const getOptionState = React40.useCallback((option) => {
  ...
  const getOptionTabIndex = React40.useCallback((optionState) => {
    if (focusManagement === "activeDescendant") {
      return void 0;
    }
  ...
  const getOptionProps = React40.useCallback((option, otherHandlers = {}) => {
...
function useMenuChangeNotifiers() {
  ...
  const notifyHighlightChanged = React42.useCallback((newValue) => {
...
function useMenu(parameters = {}) {
  ...
  const [menuItems, setMenuItems] = React43.useState({});
  const listboxRef = React43.useRef(null);
  const handleRef = useForkRef(listboxRef, listboxRefProp);
  const registerItem = React43.useCallback((id, metadata) => {
  ...
  const unregisterItem = React43.useCallback((id) => {
    setMenuItems((previousState) => {
      const newState = _extends({}, previousState);
      delete newState[id];
      return newState;
  ...
  const highlightFirstItem = React43.useCallback(() => {
    if (Object.keys(menuItems).length > 0) {
      setListboxHighlight(menuItems[Object.keys(menuItems)[0]].id);
    }
  }, [menuItems, setListboxHighlight]);
  const highlightLastItem = React43.useCallback(() => {
    if (Object.keys(menuItems).length > 0) {
  ...
  const getItemState = React43.useCallback((id) => {
    const {
      disabled,
      highlighted
    } = getOptionState(id);
...
var _excluded26 = ["actions", "anchorEl", "children", "component", "keepMounted", "listboxId", "onClose", "open", "slotProps", "slots"];
...
var MenuUnstyled = React44.forwardRef(function MenuUnstyled2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime30.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime30.jsx)(Listbox, _extends({}, listboxProps, {
      children: (0, import_jsx_runtime30.jsx)(MenuUnstyledContext_default.Provider, {
        value: contextValue,
        children
      })
    }))
...
true ? MenuUnstyled.propTypes = {
   ...
   * It's used to set the position of the popper.
   */
  anchorEl: import_prop_types27.default.oneOfType([HTMLElementType, import_prop_types27.default.object, import_prop_types27.default.func]),
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  listboxId: import_prop_types27.default.string,
  /**
...
function useForcedRerendering() {
  const [, setState] = React45.useState({});
...
function useMenuItem(props) {
  ...
  const [focusRequested, requestFocus] = React46.useState(false);
  const focusIfRequested = React46.useCallback(() => {
...
var _excluded27 = ["children", "disabled", "component", "label", "slotProps", "slots"];
...
var MenuItemUnstyled = React47.forwardRef(function MenuItemUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    disabled: disabledProp = false,
...
var _excluded28 = ["component", "disabled", "slotProps", "slots"];
...
var OptionGroupUnstyled = React48.forwardRef(function OptionGroupUnstyled2(props, ref) {
  const {
    component,
    disabled = false,
    slotProps = {},
  ...
  return (0, import_jsx_runtime33.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime32.jsx)(Label, _extends({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime32.jsx)(List, _extends({}, listProps, {
...
true ? OptionGroupUnstyled.propTypes = {
  ...
  slotProps: import_prop_types29.default.shape({
    label: import_prop_types29.default.oneOfType([import_prop_types29.default.func, import_prop_types29.default.object]),
    list: import_prop_types29.default.oneOfType([import_prop_types29.default.func, import_prop_types29.default.object]),
  ...
  slots: import_prop_types29.default.shape({
    label: import_prop_types29.default.elementType,
    list: import_prop_types29.default.elementType,
...
var SelectUnstyledContext = React49.createContext(void 0);
...
function useOption(params) {
  ...
  const selectContext = React50.useContext(SelectUnstyledContext);
  if (!selectContext) {
...
var _excluded29 = ["children", "component", "disabled", "label", "slotProps", "slots", "value"];
...
var OptionUnstyled = React51.forwardRef(function OptionUnstyled2(props, ref) {
  const {
    children,
    component,
    disabled = false,
  ...
  const selectContext = React51.useContext(SelectUnstyledContext);
  if (!selectContext) {
...
true ? OptionUnstyled.propTypes = {
   ...
   */
  value: import_prop_types30.default.any.isRequired
} : void 0;
var OptionUnstyled_default = React51.memo(OptionUnstyled);
...
function useSelectChangeNotifiers() {
  const messageBus = useMessageBus();
  const notifySelectionChanged = React52.useCallback((newValue) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newValue);
  }, [messageBus]);
  const notifyHighlightChanged = React52.useCallback((newValue) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC2, newValue);
  }, [messageBus]);
  const registerSelectionChangeHandler = React52.useCallback((handler) => {
    return messageBus.subscribe(SELECTION_CHANGE_TOPIC, handler);
  }, [messageBus]);
  const registerHighlightChangeHandler = React52.useCallback((handler) => {
...
function useSelect(props) {
  ...
  const optionsMap = React53.useMemo(() => {
  ...
  const ignoreEnterKeyUp = React53.useRef(false);
  const ignoreClick = React53.useRef(false);
  const [listboxFocusRequested, requestListboxFocus] = React53.useState(false);
  const focusListboxIfRequested = React53.useCallback(() => {
  ...
  const createHandleListboxItemClick = React53.useCallback((otherHandlers) => (event) => {
    var _otherHandlers$onClic2;
  ...
  const listboxReducer = React53.useCallback((state, action) => {
    const newState = defaultListboxReducer(state, action);
    switch (action.type) {
      case ActionTypes.keyDown:
  ...
  const optionValues = React53.useMemo(() => options.map((o) => o.value), [options]);
  const isOptionDisabled = React53.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = optionsMap.get(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [optionsMap]);
  const stringifyOption = React53.useCallback((valueToCheck) => {
    const option = optionsMap.get(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const getOptionProps = React53.useCallback((optionValue, otherHandlers = {}) => {
...
function getOptionsFromChildren(children) {
  ...
  React54.Children.forEach(children, (node2) => {
...
var _excluded30 = ["autoFocus", "children", "component", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "onChange", "onListboxOpenChange", "optionStringifier", "renderValue", "slotProps", "slots", "value"];
function defaultRenderValue(selectedOptions) {
  var _selectedOptions$labe;
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime35.jsx)(React55.Fragment, {
...
var SelectUnstyled = React55.forwardRef(function SelectUnstyled2(props, forwardedRef) {
  ...
  const handleButtonRefChange = React55.useCallback((element) => {
  ...
  const handleOpenChange = React55.useCallback((isOpen) => {
  ...
  const selectedOption = React55.useMemo(() => {
    var _options$find;
    if (multiple) {
      if (value == null) {
        return [];
  ...
  return (0, import_jsx_runtime36.jsxs)(React55.Fragment, {
    children: [(0, import_jsx_runtime35.jsx)(Button, _extends({}, buttonProps, {
      children: renderValue(selectedOption)
    })), buttonDefined && (0, import_jsx_runtime35.jsx)(Popper, _extends({}, popperProps, {
      children: (0, import_jsx_runtime35.jsx)(ListboxRoot, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime35.jsx)(SelectUnstyledContext.Provider, {
          value: contextValue,
          children
        })
      }))
    })), name && (0, import_jsx_runtime35.jsx)("input", {
      type: "hidden",
      name,
...
true ? SelectUnstyled.propTypes = {
   ...
   * @default false
   */
  defaultListboxOpen: import_prop_types31.default.bool,
  /**
   ...
   */
  getSerializedValue: import_prop_types31.default.func,
  /**
   * `id` attribute of the listbox element.
   * Also used to derive the `id` attributes of options.
   */
  listboxId: import_prop_types31.default.string,
  /**
   * Controls the open state of the select's listbox.
   * @default undefined
   */
  listboxOpen: import_prop_types31.default.bool,
  /**
   ...
   */
  onListboxOpenChange: import_prop_types31.default.func,
  /**
   ...
   */
  optionStringifier: import_prop_types31.default.func,
  /**
  ...
  slotProps: import_prop_types31.default.shape({
    listbox: import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.object]),
    popper: import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.object]),
  ...
  slots: import_prop_types31.default.shape({
    listbox: import_prop_types31.default.elementType,
...
var _excluded31 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "component", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var SliderUnstyled = React56.forwardRef(function SliderUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime38.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime37.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime37.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime38.jsxs)(React56.Fragment, {
      ...
      return (0, import_jsx_runtime38.jsxs)(Thumb, _extends({
        ...
        children: [(0, import_jsx_runtime37.jsx)(Input, _extends({
          "data-index": index,
...
true ? SliderUnstyled.propTypes = {
   ...
   */
  "aria-label": chainPropTypes(import_prop_types32.default.string, (props) => {
   ...
   */
  "aria-valuetext": chainPropTypes(import_prop_types32.default.string, (props) => {
    const range = Array.isArray(props.value || props.defaultValue);
   ...
   * The default value. Use when the component is not controlled.
   */
  defaultValue: import_prop_types32.default.oneOfType([import_prop_types32.default.arrayOf(import_prop_types32.default.number), import_prop_types32.default.number]),
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * @default false
   */
  disableSwap: import_prop_types32.default.bool,
  /**
   ...
   * @returns {string}
   */
  getAriaLabel: import_prop_types32.default.func,
  /**
   ...
   * @returns {string}
   */
  getAriaValueText: import_prop_types32.default.func,
  /**
   * If `true` the Slider will be rendered right-to-left (with the lowest value on the right-hand side).
   * @default false
   */
  isRtl: import_prop_types32.default.bool,
  /**
   ...
   * @default false
   */
  marks: import_prop_types32.default.oneOfType([import_prop_types32.default.arrayOf(import_prop_types32.default.shape({
   ...
   * @default 0
   */
  min: import_prop_types32.default.number,
  /**
   ...
   * @param {number | number[]} value The new value.
   */
  onChangeCommitted: import_prop_types32.default.func,
  /**
   ...
   * }
   */
  scale: import_prop_types32.default.func,
  /**
  ...
  slotProps: import_prop_types32.default.shape({
    ...
    mark: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    markLabel: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    rail: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    root: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    thumb: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    track: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    valueLabel: import_prop_types32.default.oneOfType([import_prop_types32.default.any, import_prop_types32.default.func])
  }),
  /**
  ...
  slots: import_prop_types32.default.shape({
    ...
    mark: import_prop_types32.default.elementType,
    markLabel: import_prop_types32.default.elementType,
    rail: import_prop_types32.default.elementType,
    root: import_prop_types32.default.elementType,
    thumb: import_prop_types32.default.elementType,
    track: import_prop_types32.default.elementType,
    valueLabel: import_prop_types32.default.elementType
  }),
  /**
   ...
   * @default 'normal'
   */
  track: import_prop_types32.default.oneOf(["inverted", "normal", false]),
  /**
   * The value of the slider.
   * For ranged sliders, provide an array with two values.
   */
  value: import_prop_types32.default.oneOfType([import_prop_types32.default.arrayOf(import_prop_types32.default.number), import_prop_types32.default.number]),
  /**
   ...
   * }
   */
  valueLabelFormat: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.string])
} : void 0;
...
var _excluded32 = ["autoHideDuration", "children", "component", "disableWindowBlurListener", "exited", "onBlur", "onClose", "onFocus", "onMouseEnter", "onMouseLeave", "open", "resumeHideDuration", "slotProps", "slots"];
...
var SnackbarUnstyled = React57.forwardRef(function SnackbarUnstyled2(props, ref) {
  const {
    autoHideDuration = null,
    children,
    component,
  ...
  return (0, import_jsx_runtime39.jsx)(ClickAwayListener_default, _extends({}, clickAwayListenerProps, {
...
true ? SnackbarUnstyled.propTypes = {
   ...
   * @default true
   */
  exited: import_prop_types33.default.bool,
  /**
   * @ignore
   */
  ...
  slotProps: import_prop_types33.default.shape({
    clickAwayListener: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.shape({
      children: import_prop_types33.default.element.isRequired,
      disableReactTree: import_prop_types33.default.bool,
      mouseEvent: import_prop_types33.default.oneOf(["onClick", "onMouseDown", "onMouseUp", "onPointerDown", "onPointerUp", false]),
      onClickAway: import_prop_types33.default.func,
      touchEvent: import_prop_types33.default.oneOf(["onTouchEnd", "onTouchStart", false])
    })]),
...
var _excluded33 = ["checked", "component", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "slotProps", "slots"];
...
var SwitchUnstyled = React59.forwardRef(function SwitchUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime41.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime40.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime40.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime40.jsx)(Input, _extends({}, inputProps))]
  }));
});
true ? SwitchUnstyled.propTypes = {
  ...
  slots: import_prop_types34.default.shape({
    ...
    track: import_prop_types34.default.oneOfType([import_prop_types34.default.elementType, import_prop_types34.default.oneOf([null])])
  })
} : void 0;
...
var _excluded34 = ["component", "count", "getItemAriaLabel", "onPageChange", "page", "rowsPerPage", "showFirstButton", "showLastButton", "direction", "ownerState", "slotProps", "slots"];
var _span;
var _span2;
var _span3;
var _span4;
function LastPageIconDefault() {
  return _span || (_span = (0, import_jsx_runtime42.jsx)("span", {
    children: "⇾|"
  }));
}
function FirstPageIconDefault() {
  return _span2 || (_span2 = (0, import_jsx_runtime42.jsx)("span", {
    children: "|⇽"
  }));
}
...
var TablePaginationActionsUnstyled = React60.forwardRef(function TablePaginationActionsUnstyled2(props, ref) {
...
var _excluded35 = ["component", "colSpan", "count", "getItemAriaLabel", "labelDisplayedRows", "labelId", "labelRowsPerPage", "onPageChange", "onRowsPerPageChange", "page", "rowsPerPage", "rowsPerPageOptions", "selectId", "slotProps", "slots"];
...
var TablePaginationUnstyled = React61.forwardRef(function TablePaginationUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime44.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime45.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime44.jsx)(Select, _extends({}, selectProps, {
        children: rowsPerPageOptions.map((rowsPerPageOption) => (0, import_react11.createElement)(MenuItem, _extends({}, menuItemProps, {
...
true ? TablePaginationUnstyled.propTypes = {
   ...
   */
  count: import_prop_types35.default.number.isRequired,
  /**
   ...
   * }
   */
  labelDisplayedRows: import_prop_types35.default.func,
  /**
   ...
   */
  labelRowsPerPage: import_prop_types35.default.node,
  /**
   ...
   */
  onPageChange: import_prop_types35.default.func.isRequired,
  /**
   * Callback fired when the number of rows per page is changed.
   *
   * @param {React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>} event The event source of the callback.
   */
  onRowsPerPageChange: import_prop_types35.default.func,
  /**
   ...
   */
  rowsPerPageOptions: import_prop_types35.default.arrayOf(import_prop_types35.default.oneOfType([import_prop_types35.default.number, import_prop_types35.default.shape({
    label: import_prop_types35.default.string.isRequired,
    value: import_prop_types35.default.number.isRequired
  })]).isRequired),
  /**
   * Id of the select element within the pagination.
   */
  selectId: import_prop_types35.default.string,
  /**
   * The props used for each slot inside the TablePagination.
   * @default {}
   */
  slotProps: import_prop_types35.default.shape({
    actions: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    displayedRows: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    menuItem: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    ...
    selectLabel: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    spacer: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
    toolbar: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object])
  }),
  /**
  ...
  slots: import_prop_types35.default.shape({
    actions: import_prop_types35.default.elementType,
    displayedRows: import_prop_types35.default.elementType,
    menuItem: import_prop_types35.default.elementType,
    root: import_prop_types35.default.elementType,
    select: import_prop_types35.default.elementType,
    selectLabel: import_prop_types35.default.elementType,
    spacer: import_prop_types35.default.elementType,
    toolbar: import_prop_types35.default.elementType
  })
} : void 0;
...
function useTabs(parameters) {
  ...
  const onSelected = React62.useCallback((e, newValue) => {
    setValue(newValue);
    if (onChange) {
      onChange(e, newValue);
    }
...
var Context = React63.createContext(null);
if (true) {
  Context.displayName = "TabsContext";
}
function useTabContext() {
  return React63.useContext(Context);
}
...
var _excluded36 = ["children", "value", "defaultValue", "orientation", "direction", "component", "onChange", "selectionFollowsFocus", "slotProps", "slots"];
...
var TabsUnstyled = React64.forwardRef((props, ref) => {
  var _ref;
  const {
    children,
    orientation = "horizontal",
  ...
  return (0, import_jsx_runtime46.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime46.jsx)(TabsContext_default.Provider, {
...
true ? TabsUnstyled.propTypes = {
   ...
   * The default value. Use when the component is not controlled.
   */
  defaultValue: import_prop_types36.default.oneOfType([import_prop_types36.default.oneOf([false]), import_prop_types36.default.number, import_prop_types36.default.string]),
  /**
   ...
   */
  selectionFollowsFocus: import_prop_types36.default.bool,
  /**
   ...
   */
  value: import_prop_types36.default.oneOfType([import_prop_types36.default.oneOf([false]), import_prop_types36.default.number, import_prop_types36.default.string])
} : void 0;
...
var _excluded37 = ["children", "component", "value", "slotProps", "slots"];
...
var TabPanelUnstyled = React65.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
function useTabsList(parameters) {
  ...
  const tabsListRef = React66.createRef();
  ...
  const processChildren = React66.useCallback(() => {
    const valueToIndex = /* @__PURE__ */ new Map();
    let childIndex = 0;
    const processedChildren = React66.Children.map(children, (child) => {
...
var _excluded38 = ["children", "component", "slotProps", "slots"];
...
var TabsListUnstyled = React67.forwardRef((props, ref) => {
  var _ref;
  const {
    component,
    slotProps = {},
  ...
  return (0, import_jsx_runtime48.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
...
function useTab(parameters) {
  ...
  } = _useButton, otherButtonProps = _objectWithoutPropertiesLoose(_useButton, _excluded39);
  const context = useTabContext();
  if (context === null) {
    throw new Error("No TabContext provided");
  }
...
var _excluded40 = ["action", "children", "value", "disabled", "onChange", "onClick", "onFocus", "component", "slotProps", "slots"];
...
var TabUnstyled = React68.forwardRef(function TabUnstyled2(props, ref) {
  var _ref;
  const {
    action,
    children,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CYBEWO5G.js.map
